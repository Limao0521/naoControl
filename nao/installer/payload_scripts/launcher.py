...
CONTROL_PY = "/data/home/nao/scripts/control_server.py"
WEB_DIR    = "/data/home/nao/Webs/ControllerWebServer"
CAMERA_PY  = "/data/home/nao/scripts/video_stream.py"
HTTP_PORT  = "8000"
...
def start_services():
    ...
    if not camera_proc:
        camera_proc = subprocess.Popen(["python2", CAMERA_PY])
    if not http_proc:
...
def stop_services():
    """Detiene todos los procesos, si están corriendo."""
    global server_proc, http_proc, camera_proc
    if http_proc:
        http_proc.terminate()
        http_proc.wait()
    ...
    while True:
        ...
        # Detecta fin de pulsación tras un hold largo
            ...
            if elapsed >= PRESS_HOLD:
                ...
                if server_proc or http_proc or camera_proc:
                    stop_services()
