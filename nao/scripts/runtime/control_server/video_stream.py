...
# -*- coding: utf-8 -*-
"""
video_stream.py – Servidor MJPEG + envío UDP de video desde NAO
...
def main():
    ...
    t = threading.Thread(target=grabber,
                         args=(video, client_name, args.server_ip, args.server_port, args.fps, args.resolution))
    t.setDaemon(True)
    t.start()
